...
手書きの図も清書した図も、同じ形をしています。読む向きは右から左です。

| 図の要素 | 読み方 |
|---|---|
| 上の帯（水色） | GitHub 側。origin と書いてあるものは全部こちら |
| 下の帯 | 自分の PC 側。編集・ステージ・コミットは全部こちら |
| 上向きの矢印 Push | 自分の PC から GitHub へ送る |
| 下向きの矢印 Pull | GitHub から自分の PC へ取り込む |
| 右端の点線枠 | 最初の1回だけやること（Clone） |
| 番号 01, 02, 03… | 実行する順番 |

つまり図は「右端でリポジトリを取ってきて、左へ進みながら編集し、上下に行き来しながら GitHub へ反映していく」という流れを描いています。
